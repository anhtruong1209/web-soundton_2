                    ...
                    <MenuCon
                        ...
                        <div style={{
                            ...
                            <ul className="nav"
                                ...
                                <li><a href={"/introduce"}>{t('text.GOI_THIEU')}</a></li>
                                <li>
                                    <a href={"/product-catalogue"}>{t('text.SAN_PHAM')}</a>
                                </li>
                                <li><a href={"/application"}>{t('text.UNG_DUNG')}</a></li>
                            </ul>
                        ...
                        <div className="menu">
                            <div style={{height: "64px"}}>
                                <div className="menu_item" style={{
                                    ...
                                    <a href="/introduce">{t('text.GOI_THIEU')}</a>
                                </div>
                            </div>
                            ...
                            <div id={"menu_cha"}>
                                <div className="menu_item" style={{
                                    ...
                                    <a href="/product-catalogue" className="desktop-item">{t('text.SAN_PHAM')}</a>
                                </div>
                            ...
                            <div style={{height: "64px"}}>
                                <div className="menu_item" style={{
                                    ...
                                    <a href="/application">{t('text.UNG_DUNG')}</a>
                                </div>
                            </div>
                        </div>
