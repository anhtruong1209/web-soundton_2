!function(s) {
    ...
    s.prototype = {
        utils: {
            ...
            replaceDiacritics: function(e) {
                for (var t = n.length; t--; )
                    e = e.toLowerCase().replace(n[t], a[t]);
                return e
            },
            format: function(e) {
                var i = arguments;
        ...
        init: function(e) {
            var t = this;
            if (t.options = c.extend(!0, {}, c.fn[u].defaults, t.options, e),
        ...
        setLabel: function() {
            ...
            if (s.state.multiple) {
                ...
                s.options.multiple.maxLabelEntries && (i.length >= s.options.multiple.maxLabelEntries + 1 ? (i = i.slice(0, s.options.multiple.maxLabelEntries)).push(c.isFunction(t) ? t({
                    text: "..."
                }) : s.utils.format(t, {
                    text: "..."
                })) : i.slice(i.length - 1)),
            ...
            e.length && (e.each(function(e) {
                ...
                if (t.is("optgroup")) {
                    ...
                    t.children().each(function(e) {
                        var t = c(this);
                        s.items[e] = i.getItemData(n, t, s.groupDisabled || t.prop("disabled")),
                        i.lookupItems[n] = s.items[e],
                        n++
                    }),
                    i.items[e] = s
                } else
                    i.items[e] = i.getItemData(n, t, t.prop("disabled")),
                    i.lookupItems[n] = i.items[e],
                    n++
            }),
            i.setLabel(),
        ...
        getItemsMarkup: function(e) {
            var s = this
              , i = "<ul>";
            return c.isFunction(s.options.listBuilder) && s.options.listBuilder && (e = s.options.listBuilder(e)),
            c.each(e, function(e, t) {
                void 0 !== t.label ? (i += s.utils.format('<ul class="{1}"><li class="{2}">{3}</li>', s.utils.arrayToClassname([s.classes.group, t.groupDisabled ? "disabled" : "", t.element.prop("class")]), s.classes.grouplabel, t.element.prop("label")),
        ...
        bindEvents: function() {
            ...
            n.elements.outerWrapper.on("mouseenter.sl mouseleave" + i, function(e) {
                ...
                n.options.openOnHover && (clearTimeout(n.closeTimer),
                "mouseleave" === e.type ? n.closeTimer = setTimeout(c.proxy(n.close, n), n.options.hoverIntentTimeout) : n.open())
            }),
            ...
            n.elements.input.prop({
                ...
                e.length && c.each(n.items, function(e, t) {
                    if (!t.disabled)
                        if (a.test(t.text) || a.test(t.slug))
                            n.highlight(e);
                        else if (t.alt)
                            for (var s = t.alt.split("|"), i = 0; i < s.length && s[i]; i++)
                                if (a.test(s[i].trim()))
                                    return void n.highlight(e)
                })
            })),
            n.$li.on({
                ...
                click: function() {
                    return n.select(c(this).data("index")),
                    !1
                }
            })
        },
        ...
        setOptionsDimensions: function() {
            ...
            !e.options.expandToItemText || i < a ? e.finalWidth = a : (e.elements.items.css("overflow", "scroll"),
        ...
        isInViewport: function() {
            ...
            if (!0 === e.options.forceRenderAbove)
                ...
                var t = l.scrollTop()
                  ...
                  , a = i + e.elements.outerWrapper.outerHeight() + e.itemsHeight <= t + s
                  , n = i - e.itemsHeight > t
                  , r = !a && n
                  , o = !r;
        ...
        detectItemVisibility: function(e) {
            ...
            t.state.multiple && (e = c.isArray(e) && 0 === e.length ? 0 : e,
            e = c.isArray(e) ? Math.min.apply(Math, e) : e);
            var i = s.eq(e).outerHeight()
              , a = s[e].offsetTop
              , n = t.elements.itemsScroll.scrollTop()
              , r = a + 2 * i;
            t.elements.itemsScroll.scrollTop(r > n + t.itemsHeight ? r - t.itemsHeight : a - i < n ? a - i : n)
        },
        open: function(e) {
            var a = this;
            ...
            a.state.enabled && (a.setOptionsDimensions(),
            c("." + a.classes.hideselect, "." + a.classes.open).children()[u]("close"),
            a.state.opened = !0,
            ...
            a.isInViewport(),
            a.options.preventWindowScroll && t.on("mousewheel.sl DOMMouseScroll" + i, "." + a.classes.scroll, function(e) {
                ...
                (s === this.scrollHeight - a.itemsInnerHeight && i < 0 || 0 === s && 0 < i) && e.preventDefault()
            }),
        ...
        change: function() {
            ...
            s.state.multiple ? (c.each(s.lookupItems, function(e) {
            ...
            s.setLabel(),
            s.utils.triggerCallback("Change", s)) : s.state.currValue !== s.state.selectedIdx && (s.$element.prop("selectedIndex", s.state.currValue = s.state.selectedIdx).data("value", s.lookupItems[s.state.selectedIdx].text),
            s.setLabel(),
        ...
        select: function(e) {
            ...
            void 0 !== e && -1 !== e && !t.lookupItems[e].disabled) {
                if (t.state.multiple) {
                    ...
                    s.removeClass("selected").filter(function(e) {
                        return -1 !== c.inArray(e, t.state.selectedIdx)
                    }).addClass("selected")
                } else
                    s.removeClass("selected").eq(t.state.selectedIdx = e).addClass("selected");
    ...
    c.fn[u] = function(t) {
        return this.each(function() {
            var e = c.data(this, u);
            e && !e.disableOnMobile ? "string" == typeof t && e[t] ? e[t]() : e.init(t) : c.data(this, u, new s(this,t))
        })
    }
    ,
    c.fn[u].defaults = {
...
function(e) {
    ...
    d.extend(d.fn, {
        validate: function(e) {
            if (this.length) {
                ...
                this.on("submit.validate", function(s) {
                    function e() {
                        var e, t;
                        return !i.settings.submitHandler || (i.submitButton && (e = d("<input type='hidden'/>").attr("name", i.submitButton.name).val(d(i.submitButton).val()).appendTo(i.currentForm)),
                        t = i.settings.submitHandler.call(i, i.currentForm, s),
                        i.submitButton && e.remove(),
                        void 0 !== t && t)
                    }
                    return i.settings.debug && s.preventDefault(),
        ...
        valid: function() {
            var e, t, s;
            return d(this[0]).is("form") ? e = this.validate().form() : (s = [],
            e = !0,
        ...
        rules: function(e, t) {
            if (this.length) {
                var s, i, a, n, r, o, l = this[0];
                if (e)
                    switch (i = (s = d.data(l.form, "validator").settings).rules,
                    ...
                    case "add":
                        ...
                        delete a.messages,
                        i[l.name] = a,
                        t.messages && (s.messages[l.name] = d.extend(s.messages[l.name], t.messages));
                        break;
                    case "remove":
                        return t ? (o = {},
                ...
                return (n = d.validator.normalizeRules(d.extend({}, d.validator.classRules(l), d.validator.attributeRules(l), d.validator.dataRules(l), d.validator.staticRules(l)), l)).required && (r = n.required,
                delete n.required,
                n = d.extend({
                    required: r
                }, n),
    ...
    d.extend(d.validator, {
        defaults: {
            ...
            highlight: function(e, t, s) {
                "radio" === e.type ? this.findByName(e.name).addClass(t).removeClass(s) : d(e).addClass(t).removeClass(s)
            },
            unhighlight: function(e, t, s) {
                "radio" === e.type ? this.findByName(e.name).removeClass(t).addClass(s) : d(e).removeClass(t).addClass(s)
            }
        },
        ...
        prototype: {
            ...
            element: function(e) {
                var t, s, i = this.clean(e), a = this.validationTargetFor(i), n = this, r = !0;
                return void 0 === a ? delete this.invalid[i.name] : (this.prepareElement(a),
                this.currentElements = d(a),
                (s = this.groups[a.name]) && d.each(this.groups, function(e, t) {
                    t === s && e !== a.name && (i = n.validationTargetFor(n.clean(n.findByName(e)))) && i.name in n.invalid && (n.currentElements.push(i),
                    r = r && n.check(i))
                }),
                t = !1 !== this.check(a),
                r = r && t,
            ...
            elementValue: function(e) {
                var t, s, i = d(e), a = e.type;
                return "radio" === a || "checkbox" === a ? this.findByName(e.name).filter(":checked").val() : "number" === a && void 0 !== e.validity ? e.validity.badInput ? "NaN" : i.val() : (t = e.hasAttribute("contenteditable") ? i.text() : i.val(),
                "file" === a ? "C:\\fakepath\\" === t.substr(0, 12) ? t.substr(12) : 0 <= (s = t.lastIndexOf("/")) ? t.substr(s + 1) : 0 <= (s = t.lastIndexOf("\\")) ? t.substr(s + 1) : t : "string" == typeof t ? t.replace(/\r/g, "") : t)
            },
            check: function(t) {
                t = this.validationTargetFor(this.clean(t));
                var e, s, i, a = d(t).rules(), n = d.map(a, function(e, t) {
                    return t
                }).length, r = !1, o = this.elementValue(t);
                ...
                for (s in a) {
                    ...
                    try {
                        if ("dependency-mismatch" === (e = d.validator.methods[s].call(this, o, t, i.parameters)) && 1 === n) {
                            r = !0;
                            continue
                        }
                        if (r = !1,
            ...
            defaultMessage: function(e, t) {
                var s = this.findDefined(this.customMessage(e.name, t.method), this.customDataMessage(e, t.method), !this.settings.ignoreTitle && e.title || void 0, d.validator.messages[t.method], "<strong>Warning: No message defined for " + e.name + "</strong>")
                  , i = /\$?\{(\d+)\}/g;
                return "function" == typeof s ? s = s.call(this, t.parameters, e) : i.test(s) && (s = d.validator.format(s.replace(i, "{$1}"), t.parameters)),
                s
            },
            ...
            defaultShowErrors: function() {
                ...
                for (e = 0; this.errorList[e]; e++)
                    s = this.errorList[e],
                    this.settings.highlight && this.settings.highlight.call(this, s.element, this.settings.errorClass, this.settings.validClass),
            ...
            showLabel: function(e, t) {
                var s, i, a, n, r = this.errorsFor(e), o = this.idOrName(e), l = d(e).attr("aria-describedby");
                r.length ? (r.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                r.html(t)) : (s = r = d("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(t || ""),
                this.settings.wrapper && (s = r.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()),
                this.labelContainer.length ? this.labelContainer.append(s) : this.settings.errorPlacement ? this.settings.errorPlacement(s, d(e)) : s.insertAfter(e),
                r.is("label") ? r.attr("for", o) : 0 === r.parents("label[for='" + this.escapeCssMeta(o) + "']").length && (a = r.attr("id"),
                l ? l.match(new RegExp("\\b" + this.escapeCssMeta(a) + "\\b")) || (l += " " + a) : l = a,
                d(e).attr("aria-describedby", l),
                (i = this.groups[e.name]) && (n = this,
                d.each(n.groups, function(e, t) {
                    t === i && d("[name='" + n.escapeCssMeta(e) + "']", n.currentForm).attr("aria-describedby", r.attr("id"))
                })))),
            ...
            errorsFor: function(e) {
                ...
                return s && (i = i + ", #" + this.escapeCssMeta(s).replace(/\s+/g, ", #")),
        ...
        classRules: function(e) {
            var t = {}
              , s = d(e).attr("class");
            return s && d.each(s.split(" "), function() {
        ...
        normalizeAttributeRule: function(e, t, s, i) {
            /min|max|step/.test(s) && (null === t || /number|range|text/.test(t)) && (i = Number(i),
            isNaN(i) && (i = void 0)),
            i || 0 === i ? e[s] = i : t === s && "range" !== t && (e[s] = !0)
        },
        attributeRules: function(e) {
            var t, s, i = {}, a = d(e), n = e.getAttribute("type");
            for (t in d.validator.methods)
                s = "required" === t ? ("" === (s = e.getAttribute(t)) && (s = !0),
                !!s) : a.attr(t),
        ...
        dataRules: function(e) {
            var t, s, i = {}, a = d(e), n = e.getAttribute("type");
            for (t in d.validator.methods)
                s = a.data("rule" + t.charAt(0).toUpperCase() + t.substring(1).toLowerCase()),
                this.normalizeAttributeRule(i, n, t, s);
            return i
        },
        staticRules: function(e) {
            ...
            return s.settings.rules && (t = d.validator.normalizeRule(s.settings.rules[e.name]) || {}),
            t
        },
            ...
            return d.each(i, function(e, t) {
                if (!1 !== t) {
                    if (t.param || t.depends) {
                        ...
                        s ? i[e] = void 0 === t.param || t.param : (d.data(a.form, "validator").resetElements(d(a)),
                        delete i[e])
                    }
                } else
                    delete i[e]
        ...
        addMethod: function(e, t, s) {
            ...
            d.validator.messages[e] = void 0 !== s ? s : d.validator.messages[e],
        ...
        methods: {
            ...
            remote: function(n, r, e, o) {
                ...
                var l, t, s, u = this.previousValue(r, o);
    ...
    var i, a = {};
    d.ajaxPrefilter ? d.ajaxPrefilter(function(e, t, s) {
        var i = e.port;
    ...
    d.ajax = function(e) {
        ...
        return "abort" === t ? (a[s] && a[s].abort(),
        a[s] = i.apply(this, arguments),
        a[s]) : i.apply(this, arguments)
    }
    )
}),
jQuery(document).ready(function(r) {
    ...
    e && !isNaN(e) && r.post(awsmJobsPublic.ajaxurl, {
    ...
    o.submit(function(e) {
        ...
        if (t) {
            var i = r("#awsm-application-form")[0]
              , a = !0;
            if (0 < r(".awsm-form-file-control").length && r(".awsm-form-file-control").each(function() {
                var e = r(this)
                  , t = void 0 !== e.prop("files")[0] && e.prop("files")[0] ? e.prop("files")[0].size : 0;
                s < t && (a = !1)
            }),
            !1 === a)
                l.addClass(c).html(awsmJobsPublic.i18n.form_error_msg.file_validation).fadeIn();
            else {
                ...
                r.ajax({
                    ...
                    if (e) {
                        var t = "awsm-default-message"
                          , s = ""
                          , i = [];
                        0 < e.error.length ? (t = c,
                        i = e.error) : 0 < e.success.length && (o[0].reset(),
                        t = d,
                        i = e.success),
                    ...
                    l.addClass(c).html(awsmJobsPublic.i18n.form_error_msg.general).fadeIn()
                }).always(function() {
...
jQuery(function(m) {
    var p = ".awsm-job-wrap"
      , f = ".awsm-job-listings"
      , g = ".awsm-filter-wrap"
      , r = window.location.protocol + "//" + window.location.host + window.location.pathname
      , o = !0;
    function l(s) {
        var i = s.find(f)
          , e = s.find(g + " form")
        ...
        m.ajax({
            ...
            0 < t.length && (0 < t.val().length ? (s.find(".awsm-job-search-btn").addClass("awsm-job-hide"),
            s.find(".awsm-job-search-close-btn").removeClass("awsm-job-hide")) : s.find(".awsm-job-search-btn").removeClass("awsm-job-hide"))
        }).fail(function(e) {}).always(function() {
            i.removeClass("awsm-jobs-loading"),
            o = !0
        }))
    }
    function v(e) {
        var t = !1;
        0 < e.length && e.find(".awsm-filter-option").each(function() {
    ...
    function t(e) {
        ...
        0 === s.length && t.find(".awsm-job-search-icon-wrapper").addClass("awsm-job-hide"),
        l(t),
        u("jq", s)
    }
    0 < m(p).length && m(p).each(function() {
        var e = m(this)
          , t = e.find(g + " form");
        (0 < awsmJobsPublic.is_search.length || v(t)) && (o = !0,
        l(e))
    });
    function u(e, t) {
    ...
    m(g + " .awsm-job-search-close-btn").on("click", function() {
        var e = m(this);
        e.parents(p).find(".awsm-job-search").val(""),
        t(e)
    }),
    ...
    m(f).on("click", ".awsm-load-more-btn", function(e) {
        ...
        if (awsmJobsPublic.is_tax_archive) {
            var c = i.data("taxonomy")
              , h = i.data("termId");
            void 0 !== c && void 0 !== h && a.push({
                name: "awsm_job_spec[" + c + "]",
                value: h
            })
        }
        a.push({
        ...
        m.ajax({
            ...
            e ? (t.parents(".awsm-load-more-main").remove(),
            i.append(e)) : t.remove()
        }).fail(function(e) {})
    }),
