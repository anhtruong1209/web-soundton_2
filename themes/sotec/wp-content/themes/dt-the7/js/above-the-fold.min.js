!function(a, b, c) {
        ...
        for (var i in u)
            if (u.hasOwnProperty(i)) {
                ...
                f = 0; f < a.length; f++)
                    g = a[f],
                    h = g.split("."),
                    1 === h.length ? w[h[0]] = e : (!w[h[0]] || w[h[0]]instanceof Boolean || (w[h[0]] = new Boolean(w[h[0]])),
                    w[h[0]][h[1]] = e),
                    t.push((e ? "" : "no-") + h.join("-"))
            }
    }
    function f(a) {
        ...
        w._config.enableClasses && (b += " " + c + a.join(" " + c),
    ...
    function k(a, c, d, e) {
        ...
        y.style.overflow = k,
        y.offsetHeight) : m.parentNode.removeChild(m),
        !!g
    }
    function l(a, b) {
        return !!~("" + a).indexOf(b)
    ...
    function p(b, d) {
        ...
        if ("CSSSupportsRule"in a) {
            for (var f = []; e--; )
                f.push("(" + h(b[e]) + ":" + d + ")");
            return f = f.join(" or "),
            k("@supports (" + f + ") { #modernizr { position: absolute; } }", function(a) {
    ...
    function q(a, b, e, f) {
        ...
        for (var k, m, n, o, q, r = ["modernizr", "tspan", "samp"]; !K.style && r.length; )
            k = !0,
            K.modElem = i(r.shift()),
    ...
    function r(a, b, c, e, f) {
        ...
        return d(b, "string") || d(b, "undefined") ? q(h, b, e, f) : (h = (a + " " + I.join(g + " ") + g).split(" "),
        n(h, b, c))
    }
    function s(a, b, d) {
        return r(a, c, c, b, d)
    ...
    var y = b.documentElement
      ...
      , A = function() {
        function a(a, b) {
            var e;
            return !!a && (b && "string" != typeof b || (b = i(b || "div")),
            a = "on" + a,
            e = a in b,
            !e && d && (b.setAttribute || (b = i("div")),
            b.setAttribute(a, ""),
    ...
    var F = "Moz O ms Webkit"
      , G = v._config.usePrefixes ? F.split(" ") : [];
    v._cssomPrefixes = G;
    var H = function(b) {
    ...
    v.atRule = H;
    var I = v._config.usePrefixes ? F.toLowerCase().split(" ") : [];
    v._domPrefixes = I;
    var J = {
        elem: i("modernizr")
    };
    ...
    var L = v.prefixed = function(a, b, c) {
        return 0 === a.indexOf("@") ? H(a) : (-1 != a.indexOf("-") && (a = g(a)),
        b ? r(a, b, c) : r(a, "pfx"))
    }
    ;
    ...
    w.addTest("forcetouch", function() {
        return !!A(L("mouseforcewillbegin", a, !1), a) && (MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN && MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN)
    }),
    v.testAllProps = s,
    w.addTest("cssanimations", s("animationName", "a", !0)),
    w.addTest("cssgridlegacy", s("grid-columns", "10px", !0)),
    w.addTest("cssgrid", s("grid-template-rows", "none", !0)),
    w.addTest("cssfilters", function() {
        if (w.supports)
            return s("filter", "blur(2px)");
        var a = i("a");
        return a.style.cssText = x.join("filter:blur(2px); "),
        !!a.style.length && (b.documentMode === c || b.documentMode > 9)
    }),
    ...
    w.addTest("csstransforms3d", function() {
        ...
        if (a && (!b || "webkitPerspective"in y.style)) {
            ...
            w.supports ? c = "@supports (perspective: 1px)" : (c = "@media (transform-3d)",
...
jQuery(document).ready(function(a) {
    ...
    a(window))
      , c = a("html")
      , d = a("body");
    dtGlobals.isiOS ? c.addClass("is-iOS") : c.addClass("not-iOS"),
    navigator.userAgent.indexOf("Safari") != -1 && navigator.userAgent.indexOf("Chrome") == -1 && d.addClass("is-safari"),
    dtGlobals.isWindowsPhone && d.addClass("ie-mobile").addClass("windows-phone"),
    dtGlobals.isMobile || d.addClass("no-mobile"),
    dtGlobals.isiPhone && d.addClass("is-iphone"),
    dtGlobals.isPhone = !1,
    dtGlobals.isTablet = !1,
    dtGlobals.isDesktop = !1;
    var e = window.getComputedStyle(document.body, ":after").getPropertyValue("content");
    e.indexOf("phone") != -1 && dtGlobals.isMobile ? dtGlobals.isPhone = !0 : e.indexOf("tablet") != -1 && dtGlobals.isMobile ? dtGlobals.isTablet = !0 : dtGlobals.isDesktop = !0;
    var f;
    !dtGlobals.isMobile || dtGlobals.isWindowsPhone || dtGlobals.isAndroid ? a(window).on("resize", function() {
        clearTimeout(f),
        f = setTimeout(function() {
            a(window).trigger("debouncedresize")
        }, 200)
    }) : a(window).bind("orientationchange", function(b) {
        clearTimeout(f),
        f = setTimeout(function() {
            a(window).trigger("debouncedresize")
        }, 200)
    }),
    b.on("debouncedresize", function(b) {
